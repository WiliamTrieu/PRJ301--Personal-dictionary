...
-- Tạo Database
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'PersonalDictionary')
BEGIN
    CREATE DATABASE PersonalDictionary;
END
GO
...
VALUES 
    ('admin@dictionary.com', 'admin123', N'Administrator', 'admin'),
...
-- =============================================
-- STORED PROCEDURES (Optional - có thể thêm sau)
-- =============================================
...
-- =============================================
-- VIEWS (Optional - có thể thêm sau)
-- =============================================
...
-- KẾT THÚC SCRIPT
-- =============================================
PRINT 'Database PersonalDictionary đã được tạo thành công!';
PRINT 'Số bảng đã tạo: 4 (Users, Dictionary, WordSuggestions, SearchHistory)';
PRINT 'Dữ liệu mẫu đã được insert.';
GO